    ...
    return (
        <div className="bg-white border border-slate-200/60 shadow-premium rounded-[24px] transition-all duration-300 p-8">
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h3 className="font-bold text-lg text-slate-900">Dòng tiền 7 ngày qua</h3>
                    <p className="text-xs text-slate-400">Theo dõi biến động thu chi hàng ngày</p>
                </div>
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-medium text-slate-500">Chi</span>
                    </div>
                </div>
            </div>
