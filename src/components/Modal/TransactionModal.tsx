        ...
        <Modal onClose={onClose} title="Giao dịch mới">
            <form onSubmit={formik.handleSubmit} className="space-y-6">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                placeholder="0"
                                className="w-full px-6 py-5 bg-slate-50 dark:bg-slate-900 border-2 border-slate-100 dark:border-slate-800 rounded-3xl focus:outline-none focus:border-blue-500 transition-all text-3xl font-black text-slate-900 dark:text-white placeholder:text-slate-200 dark:placeholder:text-slate-800"
                            />
                            <span className="absolute right-6 top-1/2 -translate-y-1/2 font-bold text-slate-400 dark:text-slate-600">
                                VND
                            </span>
                        </div>
                    </div>
                ...
                <button
                    type="submit"
                    className={twMerge(
                        "cursor-pointer w-full py-5 rounded-3xl font-extrabold text-white bg-slate-900 dark:bg-blue-600 hover:bg-slate-800 dark:hover:bg-blue-700 transition-all shadow-xl shadow-slate-900/20 dark:shadow-blue-500/20 active:scale-95 flex items-center justify-center gap-1",
                        loading && "opacity-60"
                    )}
                    disabled={loading}
                >
